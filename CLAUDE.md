...
- **Großer PVE-Host:** viel Speicher, läuft **nur bei Bedarf** (Wake-on-LAN). Clips liegen **nur hier**. Freigabe per SMB (Windows) und NFS (Mini).
- **Mini-PVE:** läuft **dauerhaft**. LXC mit Pipeline, Telegram-Bot und SQLite; Speicher des großen Hosts per NFS eingebunden. iGPU optional für Hardware-Encoding.
...
- 2026-09-23: Clips nur auf dem großen PVE-Host; Übertragung per `windows/Uebertragung.ps1` (alle 2 min, nur kopieren, Wake-on-LAN).
...
- 2026-09-23: Aufräumen: nach 182 Tagen recyceln (erst Papierkorb, nach 14 Tagen löschen), Multikills ab 3 Kills dauerhaft in `archiv/`.
